...
# Orijinal dosyandan sadece gerekenleri alıyoruz. Dosyaya DOKUNMUYORUZ!
...
def eldeki_harfleri_oku_guvenli(img):
    """
    Tahta_v11_final dosyasına hiç dokunmadan, 
    laboratuvar sonuçlarına göre sadece burada çalışan el okuyucu.
    """
...
async def coz(file: UploadFile = File(...)):
    try:
        ...
        # 1. Tahtayı senin ORİJİNAL dosyan okuyor
        tahta_matrisi, _ = tahtayi_oku(img)
        
        # 2. Eli bizim buradaki GÜVENLİ fonksiyon okuyor
